...
<div class="maindiv">
    <form method="post" action="backend_handler/absence_manager.php">
        <input style="width: 80%; height: 35px; margin: 50px 0px 0px 40px;" type="text" name="datepicker_begin"
               id="datepicker_begin" placeholder="Datum von" required="required">
        <input style="width: 80%; height: 35px; margin: 10px 0px 0px 40px;" type="text" name="datepicker_end"
               id="datepicker_end" placeholder="Datum bis" required="required">
